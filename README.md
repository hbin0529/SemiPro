...
## 마치며
> 첫 프로젝트 10일이라는 기간 동안 내가 무엇을 만들지 생각을 많이 하였고, 프로젝트를 계획하고 개발을 홀로 진행하며 전체적인 프로젝트 사이클을 이해하는 단계였습니다.
> 첫 계획했던 프로젝트는 회원가입만 한다면 동영상을 무료로 들을 수 있는 학원 사이트를 만들고, 책을 구매 및 결제 기능까지 넣고 싶었다.
> 하지만, 처음 계획했던 바와 다르게 [지식 부족] [능력 부족] [시간 부족] 이라는 핑계 아닌 핑계로 많이.. 정말 많이 축약된 프로젝트이다.
> 이것을 시작의 발판으로 더욱더 성장하는 개발자가 되고 싶습니다.
> 감사합니다.
